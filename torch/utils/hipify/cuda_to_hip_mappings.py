...
CUDA_SPECIAL_MAP = collections.OrderedDict(
    [
        ...
        (
            ...
            ("HIPSPARSELT_MATMUL_ALG_CONFIG_MAX_ID", CONV_NUMERIC_LITERAL, API_SPECIAL),
        ),
        (
        ...
        (
            ...
            ("HIPSPARSELT_MATMUL_SPLIT_K", CONV_NUMERIC_LITERAL, API_SPECIAL),
        ),
        (
            "CUSPARSELT_MATMUL_SPLIT_K_MODE",
            ("HIPSPARSELT_MATMUL_SPLIT_K_MODE", CONV_NUMERIC_LITERAL, API_SPECIAL),
        ),
